...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_questions(self):
        """was_pushished_recently returns False for questions whose pub_date is in the future"""
...
def create_question(question_text,days):
    ...
    numbers of days offset to now (negative for questions published in the past,
    positive for questions that have yet tro be publied)
    """
